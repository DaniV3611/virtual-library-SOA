  ...
  return (
    <section className="w-full py-20 flex flex-col items-center justify-center gap-4">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-4 w-full px-4">
        <Card className="w-full max-w-md lg:w-md shadow-lg hover:scale-105 transition-transform group backdrop-blur-md bg-white/60 dark:bg-black/60">
        ...
        <Card className="w-full max-w-md lg:w-md shadow-lg hover:scale-105 transition-transform group backdrop-blur-md bg-white/60 dark:bg-black/60">
          ...
          <CardContent>
            <p className="text-center">
              Download and read your favorite books quickly and easily. Take
              them with you and enjoy reading without limits.
            </p>
          </CardContent>
        </Card>
      </div>
